  ...
  <div class="login-container">
    ...
    <div class="role-option index1-box">
       ...
       <div class="teacher-top index1-top">
         <div>&nbsp&nbsp&nbsp<get_user_name></get_user_name></div>
    ...
    <div class="square-login-box">
      <div class="role-options">
        ...
        <div class="role-option teacher-box">
          ...
          <button class="teacher-btn" @click="grade_input">授课管理</button>
           <button class="teacher-btn" @click="classquery_teachert">班级查询</button>
          <!-- <button class="teacher-btn" @click="bulk_import">批量导入</button> -->
...
const classquery_teachert=()=>{
  router.push('/teacher/classquery_teacher')
}


const bulk_import=()=>{
  router.push('/teacher/bulk_import')
}

const deadline=()=>{
  router.push('/teacher/deadline')
}
